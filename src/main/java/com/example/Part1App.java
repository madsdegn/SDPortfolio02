...
public class Part1App extends Application {
    ...
    private Map<String, Part1StudentSelection> selections = new HashMap<>();
    ...
    private void addActivity(ComboBox<String> comboBox) {
        ...
        Part1StudentSelection selection = selections.get(studentName);
        if (selection == null) {

            // Create a new model object for this student
            selection = new Part1StudentSelection(studentName, program, subject1, subject2);
